...
def main():
    ...
    try:
        ...
        # 步骤2: 安装服务
        executor.setup_services(inventory_path, "init")
        executor.setup_services(inventory_path, "docker")
        executor.setup_services(inventory_path, "v2ray")
        executor.setup_services(inventory_path, "kernel")
